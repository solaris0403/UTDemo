...
import com.caowei.swipecard.transformer.StackPageTransformer;
import com.caowei.swipecard.widget.ScrollManager;
import com.caowei.utdemo.R;
...
public class StackLayout extends FrameLayout {
    ...
    private final ItemObserver mItemObserver = new ItemObserver();
    ...
    // ------ 事件分发 ------
    private final ViewDragHelper mViewDragHelper = ViewDragHelper.create(this, new ViewDragHelper.Callback() {
        private ScrollManager mScrollManager;
        private final View mParent = StackLayout.this;
...
//            Log.d(TAG, "onViewPositionChanged: " + ViewHolder.getPosition(changedView));
            ...
            final float position = (1.0f * (left - 0)) / totalRange;
...
//                        Log.d(TAG, "onViewReleased: remove" + ViewHolder.getPosition(releasedChild));
    ...
    // ------ PageTransformer ------
    private final List<PageTransformer> mPageTransformerList = new ArrayList<>();
    ...
    /**
     * 卡片滑动动画接口, 类似 {@link androidx.viewpager2.widget.ViewPager2.PageTransformer}
     */
