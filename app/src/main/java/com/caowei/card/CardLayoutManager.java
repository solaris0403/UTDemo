...
//                    view.setTranslationY((position - 1) * view.getMeasuredHeight() / CardConfig.DEFAULT_TRANSLATE_Y);
                    ...
                    view.setTranslationX((position - 1) * view.getMeasuredWidth() / CardConfig.DEFAULT_TRANSLATE_Y);
                } else if (position > 0) {
...
//                    view.setTranslationY(position * view.getMeasuredHeight() / CardConfig.DEFAULT_TRANSLATE_Y);
                    view.setTranslationX(position * view.getMeasuredWidth() / CardConfig.DEFAULT_TRANSLATE_Y);
...
//                    view.setTranslationY(position * view.getMeasuredHeight() / CardConfig.DEFAULT_TRANSLATE_Y);
    ...
    private final View.OnTouchListener mOnTouchListener = new View.OnTouchListener() {
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            if (MotionEventCompat.getActionMasked(event) == MotionEvent.ACTION_DOWN && CardConfig.DEFAULT_SHOW_ITEM > 1) {
