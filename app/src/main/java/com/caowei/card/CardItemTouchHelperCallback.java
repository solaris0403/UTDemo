...
import com.caowei.utdemo.MainActivity;
...
public class CardItemTouchHelperCallback<T> extends ItemTouchHelper.Callback {
    ...
    public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
        ...
        dataList.add(remove);
//        MainActivity.CardAdapter adapter1 = (MainActivity.CardAdapter) adapter;
//        adapter1.setList((Collection<? extends String>) dataList);
        if (mListener != null) {
...
//                    view.setTranslationY((index - Math.abs(ratio)) * itemView.getMeasuredHeight() / CardConfig.DEFAULT_TRANSLATE_Y);
                    view.setTranslationX((index - Math.abs(ratio)) * itemView.getMeasuredWidth() / CardConfig.DEFAULT_TRANSLATE_Y);
